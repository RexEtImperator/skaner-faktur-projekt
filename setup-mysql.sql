...
USE invoice_parser;
 ...
 DROP TABLE IF EXISTS `invoice_vat_breakdown`;
 ...
 CREATE TABLE `invoices` (
   ...
   `seller_bank_account` varchar(34) DEFAULT NULL,
   `seller_bdo` varchar(50) DEFAULT NULL,
   ...
   `is_split_payment_required` tinyint(1) DEFAULT 0,
   `notes` text DEFAULT NULL,
   `day_month_year` varchar(10) DEFAULT NULL,
 ...
 -- Rozbicie VAT per stawka dla faktury
